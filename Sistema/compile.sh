...
if [[ "$resposta" = 's' ]]; then
	...
	wget https://github.com/brendelvalim/config/blob/master/Sistema/cmake-2.8.12.tar.gz
	...
	mkdir badvpn-build
	cd badvpn-build
	wget https://github.com/brendelvalim/config/blob/master/Sistema/badvpn-1.999.130.tar.gz
