...
if [[ "$resposta" = 's' ]]; then
	...
	wget https://raw.githubusercontent.com/brendelvalim/config/master/Sistema/cmake-2.8.12.tar.gz
	...
	mkdir badvpn-build
	cd badvpn-build
	wget https://raw.githubusercontent.com/brendelvalim/config/master/Sistema/badvpn-1.999.130.tar.gz
